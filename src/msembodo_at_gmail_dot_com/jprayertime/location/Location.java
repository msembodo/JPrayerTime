...
public class Location {
    ...
    public Location(String address) throws IOException, JSONException {
        this.location = address;
        this.getLatLong();
    }

    private void getLatLong() throws IOException, JSONException {
        ...
        JSONObject gcResponse = new JSONObject(hr.httpGet());
